...
The Vite/React frontend is deployed at https://calle-ai.pages.dev.
...
Set `VITE_CONVEX_URL=https://fastidious-mammoth-951.convex.cloud` locally and
in Cloudflare Pages when switching the typed frontend adapters from demo data
