...
type BaselineResult = { menu: unknown; model: string; promptTokens?: number; completionTokens?: number; durationMs: number; toolCalls: number; runner: string };
